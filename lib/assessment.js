...
export function assertFourChoiceQuestions(questions, expectedCount) {
...
export function validateQuickSet(passages) {
  ...
  passages.forEach((passage) => {
    ...
    assertFourChoiceQuestions(passage.questions, 3);
  });
  return passages;
}
...
export function validateLongContent(content) {
  ...
  assertFourChoiceQuestions(content.questions, 5);
  return content;
}
